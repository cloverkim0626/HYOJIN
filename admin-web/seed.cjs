...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-font-smoothing: antialiased; }
        ...
        .badge-gray { background: #f3f4f6; color: var(--neutral-gray); border: 1px solid #e5e7eb; }
...
async function seed() {
    ...
    await supabase.from('report_classes').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    ...
    for (const className of initialClasses) {
        ...
        const students = studentsMap[className];
